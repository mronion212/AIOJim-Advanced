      ...
      <div className="relative z-20 container mx-auto px-4 py-12 min-h-screen flex flex-col items-center justify-center text-white">
        ...
        >
          ...
          <p className="text-xl sm:text-2xl text-gray-300 mb-8">
            Enhanced Stremio metadata addon with IMDb ID support for maximum compatibility.
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 text-left">
            <div className="bg-white/10 rounded-lg p-6 backdrop-blur-sm">
              <h3 className="text-xl font-semibold mb-2">IMDb ID Support</h3>
              <p className="text-gray-300">
                All catalogs use IMDb IDs as primary identifiers for maximum compatibility
                with Stremio and other addons.
              </p>
            </div>
            <div className="bg-white/10 rounded-lg p-6 backdrop-blur-sm">
              <h3 className="text-xl font-semibold mb-2">Multi-Provider</h3>
              <p className="text-gray-300">
                Combines TMDB, TVDB, MyAnimeList, and more for comprehensive metadata
                with rich artwork and detailed information.
              </p>
            </div>
          </div>
